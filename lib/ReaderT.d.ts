...
export interface ReaderT2<M extends URIS2> {
    ...
    readonly ap: <L, E, A, B>(mab: (e: E) => Type2<M, L, (a: A) => B>, ma: (e: E) => Type2<M, L, A>) => (e: E) => Type2<M, L, B>;
    readonly chain: <L, E, A, B>(ma: (e: E) => Type2<M, L, A>, f: (a: A) => (e: E) => Type2<M, L, B>) => (e: E) => Type2<M, L, B>;
...
export interface ReaderT3<M extends URIS3> {
    ...
    readonly ap: <U, L, E, A, B>(mab: (e: E) => Type3<M, U, L, (a: A) => B>, ma: (e: E) => Type3<M, U, L, A>) => (e: E) => Type3<M, U, L, B>;
    readonly chain: <U, L, E, A, B>(ma: (e: E) => Type3<M, U, L, A>, f: (a: A) => (e: E) => Type3<M, U, L, B>) => (e: E) => Type3<M, U, L, B>;
