...
interface FluentHKT2<F, I, L, A> {
    ...
    foldMapWithIndex<Ix, M>(this: FluentHKT2<F, FoldableWithIndex<F, Ix>, L, A>, M: Monoid<M>): (i: Ix, f: (a: A) => M) => M;
    ...
    partition<B extends A>(this: FluentHKT2<F, Filterable<F>, L, A>, refinement: Refinement<A, B>): Separated<HKT2<F, L, A>, HKT2<F, L, B>>;
    partition(this: FluentHKT2<F, Filterable<F>, L, A>, predicate: Predicate<A>): Separated<HKT2<F, L, A>, HKT2<F, L, A>>;
    partitionMap<RL, RR>(this: FluentHKT2<F, Filterable<F>, L, A>, f: (a: A) => Either<RL, RR>): Separated<HKT2<F, L, RL>, HKT2<F, L, RR>>;
    filterWithIndex<Ix>(this: FluentHKT2<F, FilterableWithIndex<F, Ix>, L, A>, p: (i: Ix, a: A) => boolean): FluentHKT2<F, I, L, A>;
