import { ApplicativeComposition, ApplicativeComposition11, ApplicativeComposition21, ApplicativeComposition2C1, ApplicativeComposition3C1 } from './Applicative';
...
interface OptionT3C<M extends URIS3, U, L> extends ApplicativeComposition3C1<M, URI, U, L> {
    readonly chain: <A, B>(ma: Type3<M, U, L, Option<A>>, f: (a: A) => Type3<M, U, L, Option<B>>) => Type3<M, U, L, Option<B>>;
