...
var map = function (ma, f) {
    return exports.isNone(ma) ? exports.none : some(f(ma.value));
};
var separate = function (ma) {
    return getOrElse(map(ma, function (e) { return ({
        left: getLeft(e),
        right: getRight(e)
    }); }), function () { return defaultSeparate; });
};
...
var wilt = function (F) { return function (fa, f) {
    return getOrElse(map(fa, function (a) {
...
exports.option = {
    ...
    map: map,
    of: some,
    ap: function (mab, ma) { return (exports.isNone(mab) ? exports.none : exports.isNone(ma) ? exports.none : some(mab.value(ma.value))); },
    chain: chain,
    ...
    extend: function (wa, f) { return (exports.isNone(wa) ? exports.none : some(f(wa))); },
