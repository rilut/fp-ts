 ...
 * ```
 */
import { Foldable, Foldable1, Foldable2, Foldable2C, Foldable3, Foldable3C, FoldableComposition, FoldableComposition11, FoldableComposition12, FoldableComposition12C, FoldableComposition21, FoldableComposition2C1, FoldableComposition22, FoldableComposition22C, FoldableComposition3C1 } from './Foldable';
...
export interface FoldableWithIndexComposition12C<F extends URIS, FI, G extends URIS2, GI, LG> extends FoldableComposition12C<F, G, LG> {
...
export interface FoldableWithIndexComposition2C1<F extends URIS2, FI, G extends URIS, GI, LF> extends FoldableComposition2C1<F, G, LF> {
...
export interface FoldableWithIndexComposition22<F extends URIS2, FI, G extends URIS2, GI> extends FoldableComposition22<F, G> {
    ...
    readonly reduceRightWithIndex: <LF, LG, A, B>(fga: Type2<F, LF, Type2<G, LG, A>>, b: B, f: (i: [FI, GI], a: A, b: B) => B) => B;
}
export interface FoldableWithIndexComposition22C<F extends URIS2, FI, G extends URIS2, GI, LG> extends FoldableComposition22C<F, G, LG> {
    ...
    readonly reduceRightWithIndex: <LF, A, B>(fga: Type2<F, LF, Type2<G, LG, A>>, b: B, f: (i: [FI, GI], a: A, b: B) => B) => B;
}
export interface FoldableWithIndexComposition3C1<F extends URIS3, FI, G extends URIS, GI, UF, LF> extends FoldableComposition3C1<F, G, UF, LF> {
