...
function fold(ma, onLeft, onRight) {
    return function (e) { return TE.fold(ma(e), function (l) { return onLeft(l)(e); }, function (a) { return onRight(a)(e); }); };
}
exports.fold = fold;
/**
 * @since 2.0.0
 */
function getOrElse(ma, onLeft) {
    return function (e) { return TE.getOrElse(ma(e), function (l) { return onLeft(l)(e); }); };
}
