...
function getApplicative(S) {
    return {
        ...
        reduce: Either_1.either.reduce,
        foldMap: Either_1.either.foldMap,
        reduceRight: Either_1.either.reduceRight,
        traverse: Either_1.either.traverse,
        sequence: Either_1.either.sequence,
        extend: Either_1.either.extend,
        bimap: Either_1.either.bimap,
        mapLeft: Either_1.either.mapLeft
    };
}
