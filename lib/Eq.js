...
var eqStrict = { equals: exports.strictEqual };
/**
 * @since 2.0.0
 */
 ...
 * @since 2.0.0
 */
exports.getStructEq = function (eqs) {
 ...
 * @since 2.0.0
 */
exports.getTupleEq = function () {
    var eqs = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        eqs[_i] = arguments[_i];
    }
    return exports.fromEquals(function (x, y) { return eqs.every(function (E, i) { return E.equals(x[i], y[i]); }); });
};
/**
 ...
 * @since 2.0.0
 */
exports.contramap = function (E, f) {
    return exports.fromEquals(function (x, y) { return E.equals(f(x), f(y)); });
};
/**
 * @since 2.0.0
 */
exports.eqDate = exports.contramap(exports.eqNumber, function (date) { return date.valueOf(); });
