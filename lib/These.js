...
function fromOptions(fl, fa) {
    return Option_1.foldL(fl, function () { return Option_1.foldL(fa, function () { return Option_1.none; }, function (a) { return Option_1.some(right(a)); }); }, function (l) { return Option_1.foldL(fa, function () { return Option_1.some(left(l)); }, function (a) { return Option_1.some(both(l, a)); }); });
}
