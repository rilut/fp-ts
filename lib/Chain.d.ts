 ...
 * @since 2.0.0
 */
export declare function flatMap<F extends URIS3>(F: Chain3<F>): <U, L, A, B>(f: (a: A) => Type3<F, U, L, B>) => (fa: Type3<F, U, L, A>) => Type3<F, U, L, B>;
export declare function flatMap<F extends URIS3, U, L>(F: Chain3C<F, U, L>): <A, B>(f: (a: A) => Type3<F, U, L, B>) => (fa: Type3<F, U, L, A>) => Type3<F, U, L, B>;
export declare function flatMap<F extends URIS2>(F: Chain2<F>): <L, A, B>(f: (a: A) => Type2<F, L, B>) => (fa: Type2<F, L, A>) => Type2<F, L, B>;
export declare function flatMap<F extends URIS2, L>(F: Chain2C<F, L>): <A, B>(f: (a: A) => Type2<F, L, B>) => (fa: Type2<F, L, A>) => Type2<F, L, B>;
export declare function flatMap<F extends URIS>(F: Chain1<F>): <A, B>(f: (a: A) => Type<F, B>) => (fa: Type<F, A>) => Type<F, B>;
export declare function flatMap<F>(F: Chain<F>): <A, B>(f: (a: A) => HKT<F, B>) => (fa: HKT<F, A>) => HKT<F, B>;
