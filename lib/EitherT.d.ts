...
export interface EitherM<M> extends ApplicativeComposition02<M, URI> {
    ...
    readonly foldM: <L, A, R>(ma: EitherT<M, L, A>, onLeft: (l: L) => HKT<M, R>, onRight: (a: A) => HKT<M, R>) => HKT<M, R>;
...
interface EitherM1<M extends URIS> extends ApplicativeComposition12<M, URI> {
    ...
    readonly foldM: <L, A, R>(ma: EitherT1<M, L, A>, onLeft: (l: L) => Type<M, R>, onRight: (a: A) => Type<M, R>) => Type<M, R>;
...
interface EitherM2<M extends URIS2> extends ApplicativeComposition22<M, URI> {
    ...
    readonly foldM: <LM, L, A, R>(ma: EitherT2<M, LM, L, A>, onLeft: (l: L) => Type2<M, LM, R>, onRight: (a: A) => Type2<M, LM, R>) => Type2<M, LM, R>;
