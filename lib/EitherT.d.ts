...
export interface EitherM<M> extends ApplicativeComposition02<M, URI> {
    ...
    readonly fold: <E, A, R>(onLeft: (e: E) => HKT<M, R>, onRight: (a: A) => HKT<M, R>) => (ma: EitherT<M, E, A>) => HKT<M, R>;
    ...
    readonly bracket: <E, A, B>(acquire: EitherT<M, E, A>, use: (a: A) => EitherT<M, E, B>, release: (a: A, e: Either<E, B>) => EitherT<M, E, void>) => EitherT<M, E, B>;
}
/**
 * @since 2.0.0
 */
...
export interface EitherM1<M extends URIS> extends ApplicativeComposition12<M, URI> {
    ...
    readonly fold: <E, A, R>(onLeft: (e: E) => Type<M, R>, onRight: (a: A) => Type<M, R>) => (ma: EitherT1<M, E, A>) => Type<M, R>;
    ...
    readonly bracket: <E, A, B>(acquire: EitherT1<M, E, A>, use: (a: A) => EitherT1<M, E, B>, release: (a: A, e: Either<E, B>) => EitherT1<M, E, void>) => EitherT1<M, E, B>;
}
/**
 * @since 2.0.0
 */
...
export interface EitherM2<M extends URIS2> extends ApplicativeComposition22<M, URI> {
    ...
    readonly fold: <L, E, A, R>(onLeft: (e: E) => Type2<M, L, R>, onRight: (a: A) => Type2<M, L, R>) => (ma: EitherT2<M, L, E, A>) => Type2<M, L, R>;
    ...
    readonly bracket: <L, E, A, B>(acquire: EitherT2<M, L, E, A>, use: (a: A) => EitherT2<M, L, E, B>, release: (a: A, e: Either<E, B>) => EitherT2<M, L, E, void>) => EitherT2<M, L, E, B>;
}
/**
 * @since 2.0.0
 */
