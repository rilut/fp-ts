 ...
 * @since 2.0.0
 */
exports.stateReaderTaskEitherSeq = __assign({}, exports.stateReaderTaskEither, { ap: function (mab, ma) { return exports.stateReaderTaskEither.chain(mab, function (f) { return exports.stateReaderTaskEither.map(ma, f); }); } });
