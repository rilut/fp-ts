...
function pipeOf(a) {
    ...
    return exports.pipe.apply(void 0, fns)(a);
}
exports.pipeOf = pipeOf;
...
function pipeable(I) {
    ...
    if (isApply(I)) {
        var ap = function (fab) { return function (fa) { return I.ap(fab, fa); }; };
    ...
    if (isCompactable(I)) {
        var compact = function (fa) { return I.compact(fa); };
        var separate = function (fa) { return I.separate(fa); };
        r.compact = compact;
        r.separate = separate;
    }
    if (isFilterable(I)) {
    ...
    if (isFilterableWithIndex(I)) {
        var filterWithIndex = function (predicate) { return function (fa) { return I.filterWithIndex(fa, predicate); }; };
        var filterMapWithIndex = function (f) { return function (fa) {
            return I.filterMapWithIndex(fa, f);
        }; };
        var partitionWithIndex = function (predicate) { return function (fa) { return I.partitionWithIndex(fa, predicate); }; };
